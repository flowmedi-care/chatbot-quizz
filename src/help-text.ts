...
export function buildQuizFullGuide(): string {
  return [
    ...
    "Questoes de caderno nao vao mais com enunciado no grupo — o grupo recebe um bom dia diario; enunciados via /omissas.",
    "Quando **todos os engajados** (exceto quem criou a questao) tiverem respondido, o bot posta o gabarito no grupo.",
