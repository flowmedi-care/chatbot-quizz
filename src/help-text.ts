...
export function buildQuizFullGuide(): string {
  return [
    ...
    "- Categorias pessoais apos // (ex: b 139, comentario //dificeis, lei seca)",
    "- So categorias (ja respondeu): 139 //dificeis  |  limpar: 139 //",
    "- Criar categoria: /newcat nome da categoria",
    ...
    "Cadernos: na hora de liberação (máx. 15h) saem *todas* as questões do dia de uma vez — /omissas mostra o lote completo.",
    "  Slots ao longo do dia foram descontinuados (evita 'limpo' de tarde e −50 à meia-noite por questão das 22h).",
...
export function buildQuizQuickReference(): string {
  return [
    ...
    "- b 5, comentario //dificeis — responder + categorias",
    "- 139 //dificeis, lei seca — so categorizar (ou 139 // para limpar)",
