...
export function buildQuizFullGuide(): string {
  return [
    ...
    "No **site** Papa Vagas:",
    "- **Engajamento** (global): vale para questoes manuais criadas com nova questao.",
    "- **Cadernos > Editar**: marque os engajados de cada caderno (fechamento automatico e esperar resposta).",
    ...
    "Lista o que falta responder (privado): **/omissas** — so cadernos em que voce esta engajado; nao inclui questoes que voce criou; depois **sim** ou **nao** para receber os enunciados.",
    ...
    '- ranking — mesmo que /q&a (compatibilidade)',
    "",
    "Ajuda e saida:",
    "- Guia completo: /ajuda",
...
export function buildQuizQuickReference(): string {
  return [
    ...
    "- /omissas — questoes em aberto nos cadernos em que voce esta engajado (privado)",
