...
export function buildQuizFullGuide(): string {
  return [
    ...
    "Lista o que falta responder de **outros** (privado): **/omissas** — nao inclui questoes que voce criou; depois **sim** ou **nao** para receber os enunciados.",
...
export function buildQuizQuickReference(): string {
  return [
    ...
    "- /omissas — questoes de outros que voce ainda nao respondeu (privado)",
