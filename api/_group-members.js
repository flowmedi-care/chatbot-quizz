/**
 * Lista membros do grupo do quiz com displayLabel (mesma lógica do Engajamento).
 * Usado por /api/engagement e /api/flashcards-whatsapp-users.
 */
...
/**
 * @returns {Promise<{ members: object[], warning?: string }>}
 */
async function getMembersForGroup(supabase, groupJid) {
  ...
  if (error) {
    ...
    if (msg.includes("relation") && msg.includes("does not exist")) {
      return {
        members: [],
        warning:
          "Tabela group_member_engagement inexistente. Rode a migracao SQL e use /sync-membros no grupo."
      };
    }
    throw error;
  }
